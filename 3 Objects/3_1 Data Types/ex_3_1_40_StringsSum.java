...
public class ex_3_1_40_StringsSum {
    ...
    public static void main(String[] args) {
		...
		// calculate  sum of integer and fractions parts
		...
		if (SumFractions.length() > Math.max(partsOfA[1].length(),partsOfB[1].length())) { 
			// generate string of 0s
	...
	public static String SumStrings (String inA, String inB) {
	    ...
	    int firstDigit = 0; // for the case sum exceeds longest component's length
	    int Sum;
